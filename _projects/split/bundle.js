...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _generateTree = __webpack_require__(199);

	var _generateTree2 = _interopRequireDefault(_generateTree);

	var _Tree = __webpack_require__(200);

	var _Tree2 = _interopRequireDefault(_Tree);

	var _State = __webpack_require__(203);
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)((0, _reduxLogger.createLogger)())(_redux.createStore);
	var tree = {
	    0: {
	        id: 0,
	        type: 'pane'
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    { store: createStoreWithMiddleware(_reducers2.default, tree) },
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            { className: 'grid' },
	            _react2.default.createElement(_Tree2.default, { id: 0 })
	        ),
	        _react2.default.createElement(
	            'div',
	            { className: 'state' },
...
/***/ (function(module, exports) {
	...
	function generateTree() {
	  ...
	  for (var i = 1; i < 20; i += 2) {
	    var parentId = Math.floor(Math.random() * Math.floor(i));
	    tree[i] = {
	      id: i,
	      type: 'pane'
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Pane = __webpack_require__(201);
	...
	var Node = exports.Node = function (_Component) {
	    ...
	    function Node() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Node.__proto__ || Object.getPrototypeOf(Node)).call.apply(_ref, [this].concat(args))), _this), _this.handleSplit = function (e) {
	            var _this$props = _this.props,
	                splitPane = _this$props.splitPane,
	                createPane = _this$props.createPane,
	                id = _this$props.id;

	            var lcid = createPane().nodeId;
	            var rcid = createPane().nodeId;
	            splitPane(e, id, lcid, rcid);
	        }, _this.handleClose = function (e) {
	            var _this$props2 = _this.props,
	                join = _this$props2.join,
	                id = _this$props2.id;

	            join(id);
	        }, _this.renderChild = function (id) {
	            return _react2.default.createElement(ConnectedNode, { id: id });
	            ...
	            if (type === 'split') {
	                ...
	                if (vertical) {
	                    return _react2.default.createElement(
	                        'div',
	                        { className: 'split v-split' },
	                        this.renderChild(lid),
	                        this.renderChild(rid)
	                    );
	                } else {
	                    return _react2.default.createElement(
	                        'div',
	                        { className: 'split h-split' },
	                        this.renderChild(lid),
	                        this.renderChild(rid)
	                    );
	                }
	...
	var ConnectedNode = (0, _reactRedux.connect)(function (state, ownProps) {
	    return state[ownProps.id];
	}, actions)(Node);

	exports.default = ConnectedNode;
...
/***/ (function(module, exports) {
	...
	var decideSplitDir = function decideSplitDir(e) {
	    var bounds = e.target.getBoundingClientRect();
	    var x = e.clientX - bounds.left;
	    var y = e.clientY - bounds.top;
	    var dir = void 0;
	    if (x < 1 / 4 * bounds.width) {
	        dir = 'LEFT';
	    } else if (x > 3 / 4 * bounds.width) {
	        dir = 'RIGHT';
	    } else if (y < 1 / 4 * bounds.height) {
	        dir = 'UP';
	    } else if (y > 3 / 4 * bounds.height) {
	        dir = 'DOWN';
	    } else {
	        dir = 'LEFT';
	    }
	...
	var nextId = 3;
	var splitPane = exports.splitPane = function splitPane(e, id, lcid, rcid) {
	    return {
	        type: 'PANE_CLICKED',
	        nodeId: id,
	        dir: decideSplitDir(e),
	        lcid: lcid,
	        rcid: rcid
	    };
	};

	var closePane = exports.closePane = function closePane(e, path) {
	    return {
	        type: 'PANE_CLOSE_CLICKED',
	        closePath: path
	    };
	};

	var createPane = exports.createPane = function createPane() {
	    return {
	        type: 'CREATE_PANE',
	        nodeId: nextId++
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Node = function Node(state, action) {
	    switch (action.type) {
	        ...
	        case 'PANE_CLICKED':
	            ...
	            return insert(state, nodeId, dir, lcid, rcid);
	        case 'PANE_CLOSE_CLICKED':
	            var closePath = action.closePath;

	            var newState = remove(state, closePath);
	            return newState;
	        default:
	            return state;
	    }
	...
	var insert = function insert(tree, id, dir, lcid, rcid) {
	...
	exports.default = function () {
	    ...
	    return _extends({}, state, _defineProperty({}, nodeId, Node(state[nodeId], action)));
	};
